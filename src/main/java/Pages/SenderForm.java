...
public class SenderForm {
    ...
    private WebElement individualCustomerCheckMark;
    ...
    private WebElement foreignCompanyCheckMark;

    public void clickIndividualCustomerCheckMark(){
        individualCustomerCheckMark.click();
    }

    public void clickForeignCompanyCheckMark(){
        foreignCompanyCheckMark.click();
    }
    ...
    public void ClickCompanyInPoland(){
        actionPage.scrollToElement(companyInPolandCheckMark);
        companyInPolandCheckMark.click();
    }
